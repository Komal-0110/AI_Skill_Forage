    ...
    <section
      ...
      <div className='flex items-center justify-between w-full px-2 mx-auto'>
        <div
          ...
          <h1 className={` ${!open && 'scale-0 hidden'}`}>AISkillForage</h1>
        </div>
        <div
      ...
      <ul className='absolute bottom-0 w-full gap-1 menu rounded-box'>
        ...
        <li>
          <a onClick={() => setModalLoginOpen(true)}>
            <MdLogin size={15} />
      ...
      <Modal title='Login' modalLoginOpen={modalLoginOpen} setModalLoginOpen={setModalLoginOpen}>
